...
<head>
    ...
    <title>Listar Usuários - BP Rural</title>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php while ($usuario = $result->fetch_assoc()): ?>
                    <tr>
                        <td><?php echo (int) $usuario['iduser']; ?></td>
                        <td><?php echo e($usuario['username']); ?></td>
                        <td>
                            <a href="sql_alt_usuarios.php?iduser=<?php echo (int) $usuario['iduser']; ?>" class="btn btn-warning">Alterar</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
